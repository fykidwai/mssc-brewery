...
public class BeerController {
	...
	@PostMapping
	public ResponseEntity<Object> saveBeer(final BeerDto beerDto) {
	...
	@PutMapping("/{beerId}")
	public ResponseEntity<Object> updateBeer(@PathVariable("beerId") final UUID beerId, final BeerDto beerDto) {
